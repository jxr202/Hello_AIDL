...
import static com.xman.demo_service.IDataStub.DESCRIPTOR;
import static com.xman.demo_service.IDataStub.TRANSACTION_add;
import static com.xman.demo_service.IDataStub.TRANSACTION_getData;

/**
 * Created by Jxr35 on 2020/4/5
 * Proxy类主要是用来发送数据的，
 * 通过IBinder的transact方法发送数据
 */
